...
// Adafruit GFX font, converted to the same portable form as the
// FreeSansBold10pt7b.h that ships in Waveshare's GFX examples (the
// original #includes <Adafruit_GFX.h>, which this project doesn't use).
// Used at setTextSize(1) so nothing is pixel-scaled.
